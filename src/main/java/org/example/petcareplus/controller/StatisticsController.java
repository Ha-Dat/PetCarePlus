...
public class StatisticsController {
    ...
    public String getAdminDashboard(Model model) throws JsonProcessingException{
        // Dữ liệu booking khách sạn
        List<Object[]> hotelDataRaw = hotelBookingService.getBookingCountByMonthInCurrentYear();
        // Dữ liệu booking spa
        List<Object[]> spaDataRaw = spaBookingService.getBookingCountByMonthInCurrentYear();
        ...
        List<MonthlyRevenueDTO> revenue = orderService.getMonthlyRevenue();
        model.addAttribute("revenue", revenue);
        model.addAttribute("totalCustomers", accountService.countByRole(AccountRole.CUSTOMER));
        model.addAttribute("totalManagers", accountService.countByRole(AccountRole.MANAGER));
        model.addAttribute("totalGroomers", accountService.countByRole(AccountRole.PET_GROOMER));
        model.addAttribute("totalVets", accountService.countByRole(AccountRole.VET));
        model.addAttribute("totalSellers", accountService.countByRole(AccountRole.SELLER));
